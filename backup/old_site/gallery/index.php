...
function writeEntry($game) {
	...
	<div class="gallery-entry">
		...
		<div class="info">
			<div class="title">
				<span class="section">Title: </span><?php echo $game['title']; ?>
			</div>
			<div class="author">
				<span class="section">Authors: </span><?php writeAuthors($game['title']); ?>.
			</div>
